...
//go:generate gotemplate "github.com/eosspark/eos-go/common/container/multiindex/multi_index_container" TestIndex(ById,ByIdNode,int,allocator.NoAlloc)
...
//go:generate gotemplate "github.com/eosspark/eos-go/common/container/multiindex/ordered_index" ByNum(TestIndex,TestIndexNode,ByPrev,ByPrevNode,int,int,ByNumKeyFunc,ByNumCompare,true,allocator.NoAlloc)
