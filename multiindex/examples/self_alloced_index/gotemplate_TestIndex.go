...
func NewTestIndex() (m *TestIndex) {
	if defaultAlloc == nil {
		...
		m = (*TestIndex)(defaultAlloc.Allocate(_SizeofTestIndex))
		m.super = (*ById)(defaultAlloc.Allocate(_SizeofSuperIndexTestIndex))
	}
...
func NewTestIndexNode() *TestIndexNode {
	...
	return (*TestIndexNode)(defaultAlloc.Allocate(_SizeofTestIndexNode))
}
...
func NewTestIndexBaseNode(final *TestIndexNode, pv *ValueType) *TestIndexBaseNode {
	if defaultAlloc == nil {
		return &TestIndexBaseNode{final, pv}
	}

	mbn := (*TestIndexBaseNode)(defaultAlloc.Allocate(_SizeofTestIndexBaseNode))
	mbn.final = final
	mbn.pv = pv
	return mbn
}
