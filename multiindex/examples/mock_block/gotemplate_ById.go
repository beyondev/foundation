...
func (n *ByIdNode) value() *ValueType {
...
func (i *ById) Insert(v ValueType) (IteratorById, bool) {
...
func (i *ById) insert(v ValueType, fn *TestIndexNode) (*ByIdNode, bool) {
	hash := ByIdHashFunc(v)
...
func (i *ById) Each(f func(key int, obj ValueType)) {
...
func (i *ById) Modify(iter IteratorById, mod func(*ValueType)) bool {
...
func (i *ById) modify_(iter multiindex.IteratorType, mod func(*ValueType)) bool {
	if itr, ok := iter.(IteratorById); ok {
...
func (i *ById) Values() []ValueType {
	vs := make([]ValueType, 0, i.Size())
	i.Each(func(key int, obj ValueType) {
		vs = append(vs, obj)
	})
	return vs
}
...
func (iter IteratorById) Value() (v ValueType) {
