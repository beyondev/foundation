...
//go:generate gotemplate "foundation/multiindex/multi_index_container" TestIndex(ById,ByIdNode,int,alloc)

// go:generate gotemplate "foundation/multiindex/hashed_index" ById(TestIndex,TestIndexNode,ByNum,ByNumNode,int,int,ByIdHashFunc,alloc)
//go:generate gotemplate "foundation/multiindex/hashed_index" ById(TestIndex,TestIndexNode,TestIndexBase,TestIndexBaseNode,int,int,ByIdKeyFunc,ByIdHashFunc,alloc)
var ByIdKeyFunc = func(n int) int { return n }
var ByIdHashFunc = func(n int) uintptr { return container.Hash(n) }

//go:generate gotemplate "foundation/multiindex/ordered_index" ByNum(TestIndex,TestIndexNode,ByPrev,ByPrevNode,int,int,ByNumKeyFunc,ByNumCompare,true,alloc)
var ByNumKeyFunc = func(n int) int { return n + 1 }
var ByNumCompare = container.IntComparator

//go:generate gotemplate "foundation/multiindex/hashed_index" ByPrev(TestIndex,TestIndexNode,TestIndexBase,TestIndexBaseNode,int,int,ByPrevKeyFunc,ByPrevHashFunc,alloc)
